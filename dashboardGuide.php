            ...
            <div class="bg-white rounded-xl shadow-lg p-6 mb-8">
                <div class="flex items-center justify-between mb-6">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">À venir dans 2 heures</p>
                        </div>
                    </div>
                ...
                <div class="border border-blue-200 rounded-xl p-6 bg-gradient-to-r from-blue-50 to-white">
                    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
                        <div>
                            <h3 class="text-2xl font-bold text-gray-800 mb-2">Découverte des félins d'Afrique</h3>
                            <div class="flex items-center text-gray-600">
                                <i class="far fa-calendar mr-2"></i>
                                <span>Aujourd'hui, 15h00 - 17h00</span>
                            </div>
                        </div>
                        <div class="mt-4 md:mt-0">
                            <div class="text-2xl font-bold text-blue-600">150 DH</div>
                        ...
                        <div class="bg-white p-4 rounded-lg shadow-sm">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-xl font-bold text-gray-800">24/30</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white p-4 rounded-lg shadow-sm">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-xl font-bold text-gray-800">Français</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white p-4 rounded-lg shadow-sm">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-xl font-bold text-gray-800">120 min</p>
                                </div>
                            </div>
                        </div>
                    </div>
