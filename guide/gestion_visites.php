...
$result = $conn->query("SELECT * FROM visitesguidees inner join utilisateurs on visitesguidees.id_guide =  utilisateurs.id where utilisateurs.id = {$_SESSION['user_id']} ORDER BY dateheure DESC");
?>
        ...
        <div class="flex flex-col md:flex-row justify-between items-center">
            ...
            <div class="mt-4 md:mt-0">
                <span class="bg-green-600 px-4 py-2 rounded-full text-sm font-medium">
                    <?php echo $result->num_rows; ?> visite(s)
                </span>
            </div>
        </div>
    </div>
        ...
        <div class="px-6 py-4 bg-gray-50 border-b">
            <div class="flex justify-between items-center">
                ...
                <span class="text-sm text-gray-600">
                    <?php echo $result->num_rows; ?> visite(s) programmée(s)
                </span>
            </div>
        </div>
        ...
        <div class="px-6 py-4 bg-gray-50 border-t">
            <div class="flex items-center justify-between">
                <div class="text-sm text-gray-600">
                    Affichage de 1 à <?php echo $result->num_rows; ?> visite(s)
                </div>
                <div class="flex space-x-2">
...
<script>
    // Fonction pour éditer une visite (simulation)
    function editVisite(id) {
        // Ici, vous remplaceriez par une requête AJAX pour récupérer les données
        alert('Fonction d\'édition pour la visite #' + id + '\nÀ implémenter avec AJAX');

        // Exemple de ce que vous pourriez faire :
        // document.getElementById('visiteId').value = id;
        // Remplir les champs du formulaire avec les données de la visite
