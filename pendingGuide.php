...
// Vérifier si le guide est approuvé
$user_id = $_SESSION['user_id'];
$user_nom = $_SESSION['user_nom'];
$role = $_SESSION['role'];
$is_approved = isset($_SESSION['is_approved']) ? $_SESSION['is_approved'] : false;

if ($role === 'guide' && $is_approved) {
    header('Location: dashboard-guide.php');
    exit();
}

// // Si ce n'est pas un guide, rediriger vers la page appropriée
// if ($role !== 'guide') {
...
<!-- Hero Section avec style différent pour non-approuvé -->
