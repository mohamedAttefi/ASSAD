...
$sql = "SELECT r.id, v.titre, v.description, v.date_visite, v.duree, v.prix, 
               r.nbpersonnes, r.datereservation, r.statut,
               g.nom as guide_nom, g.prenom as guide_prenom
        FROM reservations r
        JOIN visitesguidees v ON r.idvisite = v.id
        LEFT JOIN guides g ON v.guide_id = g.id
...
<div class="max-w-7xl mx-auto px-4 mb-10">
    ...
    <?php if ($result->num_rows > 0): 
        ...
        while($row = $result->fetch_assoc()):
            $visit_date = new DateTime($row['date_visite']);
            $today = new DateTime();
        ...
        // Réinitialiser à nouveau pour l'affichage
        $result->data_seek(0);
    ?>
    ...
    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
        ...
        <div class="px-6 py-4 bg-gradient-to-r from-green-50 to-emerald-50 border-b">
            <div class="flex justify-between items-center">
                ...
                <span class="text-sm text-gray-600">
                    <?php echo $result->num_rows; ?> réservation<?php echo $result->num_rows > 1 ? 's' : ''; ?>
                </span>
            </div>
        </div>
        ...
        <?php else: ?>
                                ...
                                <div class="space-y-2">
                                    <div class="flex items-center">
                                        ...
                                        <span class="font-medium">
                                            <?php echo date('d/m/Y', strtotime($row['date_visite'])); ?>
                                        </span>
                                    </div>
                                    <div class="flex items-center">
                                        <svg class="w-5 h-5 text-gray-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-sm text-gray-600">
                                            <?php echo htmlspecialchars($row['guide_prenom'] . ' ' . $row['guide_nom']); ?>
                                        </span>
                                    </div>
                                    <?php endif; ?>
                                </div>
            ...
            <div class="px-6 py-4 bg-gray-50 border-t">
                <div class="flex items-center justify-between">
                    <div class="text-sm text-gray-600">
                        Affichage de 1 à <?php echo $result->num_rows; ?> sur <?php echo $result->num_rows; ?> résultats
                    </div>
                    <div class="flex space-x-2">
