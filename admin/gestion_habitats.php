...
// Récupérer la liste des habitats avec statistiques
$result = $conn->query("
        ...
        <div class="flex flex-col md:flex-row justify-between items-center">
            ...
            <div class="mt-4 md:mt-0">
                <span class="bg-green-600 px-4 py-2 rounded-full text-sm font-medium">
                    <?php echo $result->num_rows; ?> habitat(s) créé(s)
                </span>
            </div>
        </div>
    </div>
        ...
        <div class="px-6 py-4 bg-gray-50 border-b">
            <div class="flex justify-between items-center">
                ...
                <span class="text-sm text-gray-600">
                    <?php echo $result->num_rows; ?> habitat(s)
                </span>
            </div>
        </div>
            ...
            <div class="px-6 py-4 bg-gray-50 border-t">
                <div class="flex items-center justify-between">
                    <div class="text-sm text-gray-600">
                        Affichage de 1 à <?php echo $result->num_rows; ?> habitat(s)
                    </div>
                    <div class="flex space-x-2">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
        ...
        <div class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-6 border border-green-200">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="text-center p-4 bg-white rounded-lg shadow-sm">
                    <p class="text-2xl font-bold text-amber-600"><?php echo $stats['total_animaux'] ?? 0; ?></p>
