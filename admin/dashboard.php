...
$reservations_today = $conn->query("SELECT COUNT(*) as total FROM reservations WHERE DATE(datereservation) = CURDATE()")->fetch_assoc()['total'];
$total_revenue = $conn->query("
    SELECT SUM(v.prix * r.nbpersonnes) as total 
    FROM reservations r 
    JOIN visitesguidees v ON r.idvisite = v.id")->fetch_assoc()['total'] ?? 0;

// Derniers utilisateurs
$latest_users = $conn->query("SELECT nom, email FROM utilisateurs ORDER BY nom DESC LIMIT 5");
...
<div class="max-w-7xl mx-auto px-4 mb-10">
        ...
        <div class="bg-gradient-to-br from-blue-500 to-blue-600 text-white rounded-xl shadow-lg p-6 transform hover:-translate-y-2 transition-transform duration-300">
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <p class="text-3xl font-bold"><?php echo number_format($total_visiteurs); ?></p>
    ...
    <div class="grid md:grid-cols-2 gap-8">
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="p-6">
                <div class="space-y-4">
                    <?php if ($latest_users->num_rows > 0): ?>
