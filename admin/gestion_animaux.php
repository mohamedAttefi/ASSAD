...
$habitats = $conn->query("SELECT id, nom FROM habitats ORDER BY nom");
?>
        ...
        <div class="flex flex-col md:flex-row justify-between items-center">
            ...
            <div class="mt-4 md:mt-0">
                <span class="bg-green-600 px-4 py-2 rounded-full text-sm font-medium">
                    <?php echo $result->num_rows; ?> animal(s) enregistré(s)
                </span>
            </div>
        </div>
    </div>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <div class="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-green-400 transition cursor-pointer"
                         onclick="document.getElementById('animal-image').click()">
                        <input type="file" 
                               name="image" 
                               id="animal-image"
                               class="hidden"
                        ...
                        <p class="text-gray-600">Cliquez pour ajouter une image</p>
                        <p class="text-sm text-gray-500 mt-1">JPG, PNG ou GIF (max 2MB)</p>
                        <p id="image-name" class="text-green-600 text-sm mt-2 hidden"></p>
                    </div>
                </div>
        ...
        <div class="px-6 py-4 bg-gray-50 border-b">
            <div class="flex justify-between items-center">
                ...
                <span class="text-sm text-gray-600">
                    <?php echo $result->num_rows; ?> animal(s)
                </span>
            </div>
        </div>
            ...
            <div class="px-6 py-4 bg-gray-50 border-t">
                <div class="flex items-center justify-between">
                    <div class="text-sm text-gray-600">
                        Affichage de 1 à <?php echo $result->num_rows; ?> animal(s)
                    </div>
                    <div class="flex space-x-2">
