    ...
    <header class="sticky top-0 z-50 bg-green-700 text-white shadow-md">
        <div class="container mx-auto px-4">
            <div class="flex items-center justify-between h-16">
                <!-- Logo -->
                <a href="/ASSAD/index.php" class="flex items-center space-x-3 hover:opacity-90 transition">
                ...
                <nav class="hidden md:flex items-center space-x-6">
                    ...
                    <a href="/ASSAD/animaux.php" class="hover:text-green-200 transition font-medium">
